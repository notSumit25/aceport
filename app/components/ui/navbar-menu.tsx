...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent bg-black dark:border-white/[0.2] shadow-input flex justify-center space-x-4 px-8 py-6 text-white"
    >
      {children}
    </nav>
  );
